...
const STRINGS = {
  en: {
    ...
    cameraError: "Couldn't access the camera — choose a photo from your gallery instead.",
  ...
  ar: {
    ...
    cameraError: "تعذّر الوصول إلى الكاميرا — اختر صورة من معرض هاتفك بدلاً من ذلك.",
    nameOptional: "اسمك (اختياري)",
    playMusic: "تشغيل الموسيقى",
    pauseMusic: "إيقاف الموسيقى",
    preview: "معاينة",
    wedding: "زفاف",
    waitingForYou: "في انتظاركم",
  },
};
